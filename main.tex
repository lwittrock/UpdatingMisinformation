...
\date{Draft: \today
\\
\href{http://www.larswittrock.eu/files/UpdatingMisinformation.pdf}{Click here for most recent version}}
...
All belief reports were incentivized using a quadratic scoring rule.\footnote{The specific elicitation method was chosen for the ease of explanation. Following \cite{Danz2020}% additional source Che (Christina) Sun, work in progress paper
